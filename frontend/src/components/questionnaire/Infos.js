...
function Infos({ formData, setFormData }) {
  ...
  return (
    <div className='form-body'>
        ...
        error={(error === 'youngError') ? {message: "L'âge minimum requis est de 18 ans", style:{borderColor: 'red'}} : ''} 
        ...
        <div className='span-gender'>
          <div className='form-check'>
            ...
            <input name='gender' id='male' type='radio' className="form-check-input" onKeyDown={e => e.preventDefault()}
          ...
          <div className='form-check'>
            ...
            <input name='gender' id='female' type='radio' className="form-check-input" onKeyDown={e => e.preventDefault()}
